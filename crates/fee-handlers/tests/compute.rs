use fee_handlers::types::*;
use fee_handlers::compute::*;
...
fn l1_fee_v1_celestia_math() {
    let params = L1FeeParams::V1 { v1: V1Params { share_size: 512, overhead_shares: 1, blob_price_scalar: 1_000_000, decimals: 6 } };
    // 120_000 bytes -> ceil(120000/512)=235 shares; +1 overhead = 236 shares
    let txb = TxBytesAcc { total_size: 120_000, ..Default::default() };
